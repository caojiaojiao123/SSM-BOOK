...
<body background="image/6.jpg">
	...
	<div class="container-fluid" id="div9">
		...
		<div class="col col-md-5 col-md-offset-2" id="div1">
			...
			<hr>
			<form action="addBook" method="post" name="register" id="bf"
				class="form-horizontal">

				<div class="form-group">
					<label class="col-sm-3 col-sm-offset-2 control-label text-info">选择分类:</label>
					<div class="col-sm-4">
						<select name="fid" style="color: #265C88;"
				...
				<div class="form-group">
					<label class="col-sm-3 control-label col-sm-offset-2 text-info">状态:</label>
					<div class="col-sm-4">
				...
				<div class="form-group">
					<label class="col-sm-3 control-label col-sm-offset-2 text-info">库存量:</label>
					<div class="col-sm-4">
