...
<link rel="stylesheet" href="http://localhost/ssm-book/bootstrap/css/bootstrap.css" />
<script type="text/javascript" src="http://localhost/ssm-book/bootstrap/js/jquery.js"></script>
<script type="text/javascript" src="http://localhost/ssm-book/bootstrap/js/bootstrap.js"></script>
<link rel="stylesheet" href="http://localhost/ssm-book/bootstrap/css/bootstrapValidator.css" />
<script type="text/javascript" src="http://localhost/ssm-book/bootstrap/js/bootstrapValidator.js"></script>
				...
				name : {
					validators : {
						...
						remote : {//ajax验证。server result:{"valid",true or false} 向服务发送当前input name值，获得一个json数据。例表示正确：{"valid",true}  
							url : "http://localhost/ssm-book/yzupdateBook",//验证地址
...
<body>
	...
	<div class="container-fluid" id="div9">
		...
		<div class="col col-md-5 col-md-offset-2" id="div1">
			...
			<form action="http://localhost/ssm-book/updateBook" method="post" id="bd"
				...
				<div class="form-group">
					<label class="col-sm-3 col-sm-offset-2 control-label text-info">库存量:</label>
					<div class="col-sm-4">
				...
				<div class="form-group">
					...
					<div class="col-sm-2  col-sm-offset-1">
						...
						<a href="http://localhost/ssm-book/showBookHandler/${pageNow }"
